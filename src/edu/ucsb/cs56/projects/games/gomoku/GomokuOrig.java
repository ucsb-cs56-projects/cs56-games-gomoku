...
/**
 * Gomoku is a game where player take turns to place a colored stones on a
 * chess-style board of various sizes. The first person to get five stones of
 * her own color in a row either horizontally, vertically or diagonally wins.
 * 
...
public class GomokuOrig extends JPanel implements MouseListener {
	...
	// All functions need to be written (even if they are empty) in order to
	// comply with the MouseListener interface
	 ...
	 * 
	 * @param mouse
	 *            - the MouseEvent with information on where the player has
	 *            clicked
	 */
