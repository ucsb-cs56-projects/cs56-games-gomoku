...
/**
 * a controller to control user interactions, such as clicking button
 * Last edited by Eric Huang for project 2 Spring 2013
 * @see Gomoku
 */

public class Controller
{
	/* ignore my comments from earlier, that was just me trying to
	 * ignore the problem
	 */
	 ...
	 /** 
	  * constructor
	  * intialize the default to 0, and set the panel because later
	  * I want to use getTileSize
	  * @param panel the panel of the Gomoku game
	  */
	  ...
	  * @param mouse where the user clicked on the grid
	  */
